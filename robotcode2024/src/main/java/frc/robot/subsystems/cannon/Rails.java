...
public class Rails extends SubsystemBase {
        ...
        Rails() {
            ...
            lWinch = new CANSparkMax(Constants.CAN.ELEVATOR, MotorType.kBrushless);
            rWinch = new CANSparkMax(Constants.CAN.IPIVOT, MotorType.kBrushless);
        ...
        public void moveElev(double motorLWinchPower, double motorRWinchPower) {
