...
public class SplineGenerator {
    ...
    public static List<Pose2dWithMotion> parameterizeSpline(PoseSpline s, double maxDx, double maxDy,
            double maxDTheta) {
    ...
    private static void getSegmentArc(PoseSpline s, List<Pose2dWithMotion> rv, double t0, double t1, double maxDx,
        ...
        Rotation2d course_predicted = (new Rotation2d(twist_full.dx, twist_full.dy, true))
